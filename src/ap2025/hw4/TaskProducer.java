...
public class TaskProducer implements Runnable {
    ...
    public void run() {
        ...
        for (int i = 0; i < numberOfTasksToProduce && !shutdownRequested; i++) {
            try {
                ...
                Priority taskPriority = choosePriority();
                String description = "Salam";
                Task task = new Task(taskId, description, taskPriority);
    ...
    public Priority choosePriority() {
        ...
        int randomIndex = RAND.nextInt(priorities.length);
